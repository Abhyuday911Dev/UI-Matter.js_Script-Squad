...
Composite.add(engine.world, [
  ...
  Bodies.rectangle(
    innerw / 2,
    innerh * 5 + innerh / 4 + (innerh - innerh / 4) / 2 + 10 - bottombondfig,
    innerw,
    innerh - innerh / 4,
    {
      isStatic: true,
  ...
  Bodies.rectangle(
    innerw,
    (innerh * 5) / 2 - (innerh - innerh / 2) * 1.7,
    5,
    innerh * 6 - 500,
    {
      isStatic: true,
  ...
  Bodies.rectangle(
    0,
    (innerh * 5) / 2 - (innerh - innerh / 2) * 1.5,
    5,
    innerh * 6 - 500,
    {
      isStatic: true,
...
// ________________________day2 codes____________________________
// ________________________day2 codes____________________________
// ________________________day2 codes____________________________
